...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $mail->Subject = 'Password Reset OTP - OnlineOPD (Doctor)';
        $mail->Body    = "Your OTP to reset your doctor account password is: $otp";

        $mail->send();
        header("Location: doctor_verify_reset.php");
        exit;
    } catch (Exception $e) {
...
<body>
    <form method="POST">
        ...
        <p>Enter your registered doctor email to receive OTP.</p>
